...
export default function MovieModal() {
	...
	return (
		<div className="fixed inset-0 z-10">
			...
			<div className="absolute w-3/4 h-[90%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded">
				<div className="p-4 flex justify-center flex-col items-center ">
					<div className="w-[70%] mb-3 mt-4">
						<Typography variant="h4" color="blue-gray" className="text-xl">
							{title} movie
						</Typography>
					</div>
					<form className="w-[70%] flex gap-5" onSubmit={handleSubmit}>
						<div>
